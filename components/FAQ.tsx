        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24">
            ...
            <div className="lg:col-span-4">
                ...
                <div className="p-6 bg-white rounded-lg border border-gray-100 shadow-sm">
                    <h4 className="font-bold text-dark text-sm mb-2">Need immediate support?</h4>
                    <p className="text-gray-400 text-xs mb-4">Our studio team is online.</p>
                    <a href="#audit" className="text-neonHover font-bold text-xs uppercase tracking-widest underline">Contact Support</a>
                </div>
            </div>
                ...
                <div className="space-y-4">
                    {faqs.map((faq, index) => (
                        ...
                        >
                            ...
                            >
                                <span className={`font-bold transition-colors ${openIndex === index ? 'text-dark' : 'text-gray-500'}`}>
                                    {faq.question}
                                </span>
                                {openIndex === index ? (
